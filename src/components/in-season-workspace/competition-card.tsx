...
export function CompetitionCard({
  ...
  // `canCompose` is a Sorare-side permission flag. We don't gate navigation
  // on it (this is a prep tool — users may want to draft for closed/future
  // GWs) but we still surface a tiny lock badge as a hint.
  const sorareClosed = !rep.canCompose;
        ...
        <div className="ml-auto flex items-center gap-1 shrink-0">
          {sorareClosed && (
            <Lock
              ...
              aria-label="Composition closed at Sorare — drafts still allowed"
            />
          )}
